  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
	  ...
	  <!-- <div class="item form-group">
           ...
           <div class="clearfix"></div>
        <form class="form-horizontal form-label-left" action="appAdd.do" method="post" enctype="multipart/form-data">
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="softwareSize" name="softwareSize"  onkeyup="value=value.replace(/[^\d]/g,'')"
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="file" class="form-control col-md-7 col-xs-12" name="mf"  required="required" id="a_logoPicPath"/>
            ${fileUploadError }
            </div>
          </div>
